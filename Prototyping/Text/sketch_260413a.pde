...
String harrington = "Harrington"; //Spelling of the Font Matters, see PFont.lisr() v Create Font above
font = createFont(harrington, fontSize);
//
// Aspect Ratio for Harrington
fontSize = 83; //Default fontSize for ~100%
float harringtonAspectRatio = songTitleDivWidth; //Key:Value, value=120
float harringtonAspectRatio = fontsize / divHeightHarrington; //#<1
...
color whiteInk = #FFFFFF; //Grey scale 255
color resetInk = whiteInk;
fill(purpleInk); //Ink, hexidecimal copied from colour selector
//Gray Scale 0-255
